...
def postprocess(image):
    ...
    predicted_mask = morphology.binary_opening(image) #ESTA NO HACE MUCHO NO SE SI QUITARLA
    # Second postprocess technqiue in order to fill the holes in the objects: dilation
    predicted_mask = morphology.binary_dilation(image) # ESTA ES LA QUE SUBE LA PUNTUACION!
